...
-D${APPLICATION_NAME}.config.workersRoot=${WORKERS_ROOT} -D${APPLICATION_NAME}.config.lifeSpawnChance=${LIFESPAWNCHANCE} -D${APPLICATION_NAME}.config.loadFromOutside=${LOADFROMOUTSIDE} -Dstart-stepped=${STEPPED} 
